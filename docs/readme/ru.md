<div align="center">
  <a href="https://github.com/kimght/LimbusScreenTranslator">
    <img src="../assets/logo_full.webp" width="160" height="160" alt="Логотип Limbus Screen Translator" />
  </a>

<sub>[English](/ru.md) · **Русский**</sub>
...
<p align="center">
  <img src="../assets/story.webp" width="900" alt="Переведённый диалог поверх Limbus Company" />
</p>
...
<table>
  <tr>
    <td align="center" width="33%">
      <strong>01 · Выберите</strong><br /><br />
      <img src="../assets/library.webp" width="100%" alt="Библиотека локализаций с доступными фанатскими переводами" />
    </td>
    <td align="center" width="33%">
      <strong>02 · Установите</strong><br /><br />
      <img src="../assets/localization.webp" width="100%" alt="Сведения о локализации с кнопкой «Установить»" />
    </td>
    <td align="center" width="33%">
      <strong>03 · Играйте</strong><br /><br />
      <img src="../assets/installed.webp" width="100%" alt="Активная локализация с кнопкой «Открыть переводчик»" />
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="../assets/chapters.webp" width="100%" alt="Выбор главы и эпизода поверх игры" /><br />
      <sub><strong>Выберите нужные главу и эпизод</strong></sub>
    </td>
    <td align="center" width="50%">
      <img src="../assets/resize.webp" width="100%" alt="Управление размером плавающего окна" /><br />
      <sub><strong>Перемещайте, изменяйте размер или сворачивайте плавающее окно</strong></sub>
    </td>
  </tr>
</table>
...
<a href="https://github.com/kimght/LimbusScreenTranslator/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=kimght/LimbusScreenTranslator" alt="Участники проекта" />
</a>
